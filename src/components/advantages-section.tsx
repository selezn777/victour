  ...
  return (
    <div className="flex h-full w-full flex-col overflow-hidden">
      ...
      <div className="flex flex-1 flex-col items-center justify-[safe_center] overflow-y-auto px-4 pt-1 pb-6 text-center sm:px-11 sm:pt-2">
        ...
        {/* "Проверен лично" — Виктор резко забраковал: это говорит любой
            конкурент, не отражает суть. Идея не в проверке, а в том, что
            маршруты авторские и выверенные, а их мало ИМЕННО ПОТОМУ, что
            это самый безопасный и глубокий способ увидеть страну — не
            общая гарантия качества, а конкретная причина малого числа. */}
        <p className="mt-3 max-w-md text-lg leading-snug font-medium text-foreground sm:mt-5 sm:max-w-xl sm:text-xl">
          Авторские маршруты, выверенные до мелочей. Их мало, потому что это самый безопасный и
          глубокий способ увидеть страну.
        </p>
