        ...
        <ValuesSlide
          ...
          points={[
            ...
            },
            {
              ...
              body: "Не тратим время на места с низким качеством и туристическими ценами. Если что-то советуем - это напрямую от местных, из первых рук и без нашего процента.",
            },
            {
              title: "Ешьте то, что вам нравится",
              body: "По пути - только рестораны, где каждый заказывает то, что реально хочет съесть, а не стандартный пережаренный вьетнамский сет, после которого потом тяжело в животе несколько дней.",
            },
          ]}
        />,
        <QuoteSlide
