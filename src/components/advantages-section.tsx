  ...
  return (
    <div className="flex h-full w-full flex-col overflow-hidden">
      ...
      <div className="flex flex-1 flex-col items-center justify-[safe_center] overflow-y-auto px-4 pt-1 pb-6 text-center sm:px-11 sm:pt-2">
        ...
        {/* Виктор попросил добавить сюда, что это полноценная экскурсия
            с сопровождением на всём протяжении, а не просто трансфер. */}
        <p className="mt-2 max-w-md text-base leading-snug text-muted-foreground sm:mt-3 sm:max-w-xl sm:text-lg">
          Это полноценная экскурсия: везде сопровождаем, обо всём расскажем, никуда не торопим и
          решаем любые вопросы прямо в дороге.
        </p>
        ...
        <ValuesSlide
          ...
          points={[
            ...
            },
            {
              ...
              // голосовым, вместо прошлой "Ешьте то, что вам нравится".
              title: "Забудьте про пережаренную еду, от которой вам плохо",
              body: "Заказывайте то, что хотите по-настоящему съесть.",
            },
          ]}
        />,
        <QuoteSlide
