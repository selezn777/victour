...
// Длительность падения+разлёта всей стопки одним движением (раньше 610мс
// на карточку при стаггере, потом 260мс при быстром каскаде) — сейчас это
// ЕДИНСТВЕННАЯ анимация (нет паузы между карточками), поэтому длительность
// подобрана под неё целиком: достаточно, чтобы разлёт по сторонам был
// читаем, не мгновенным "морганием".
const DROP_ENTER_DURATION_MS = 420
